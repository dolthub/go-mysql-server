...
var _ fulltext.FulltextIndex = (*Index)(nil)
...
func (idx *Index) FullTextTableNames(ctx *sql.Context) (config string, wordIdMap string, count string, exists bool) {
	return idx.Tbl.fullTextConfigTableName, idx.fulltextInfo.WordToPosTableName, idx.fulltextInfo.CountTableName, idx.Fulltext
}
