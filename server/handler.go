...
func (h *Handler) resultForRowFrameIter(ctx *sql.Context, c *mysql.Conn, iter sql.RowFrameIter, resultFields []*querypb.Field, callback func(*sqltypes.Result, bool) error, more bool) (*sqltypes.Result, bool, error) {
	defer trace.StartRegion(ctx, "Handler.resultForRowFrameIter").End()
