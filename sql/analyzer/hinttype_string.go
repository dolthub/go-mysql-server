...
func _() {
	...
	_ = x[HintTypeNoIndexConditionPushDown-9]
	_ = x[HintTypeMaxExecutionTime-10]
	_ = x[HintTypeSetVar-11]
}

const _HintType_name = "JOIN_ORDERJOIN_FIXED_ORDERMERGE_JOINLOOKUP_JOINHASH_JOINSEMI_JOINANTI_JOININNER_JOINNO_ICPMAX_EXECUTION_TIMESET_VAR"

var _HintType_index = [...]uint8{0, 0, 10, 26, 36, 47, 56, 65, 74, 84, 90, 108, 115}
