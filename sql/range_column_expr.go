...
func (r MySQLRangeColumnExpr) IsConnected(ctx *Context, other MySQLRangeColumnExpr) (bool, error) {
	if r.Typ.String(ctx) != other.Typ.String(ctx) {
		return false, nil
	}
...
func (r MySQLRangeColumnExpr) Overlaps(ctx *Context, other MySQLRangeColumnExpr) (MySQLRangeColumnExpr, bool, error) {
	if r.Typ.String(ctx) != other.Typ.String(ctx) {
...
// is nil.
func (r MySQLRangeColumnExpr) TryIntersect(ctx *Context, other MySQLRangeColumnExpr) (MySQLRangeColumnExpr, bool, error) {
...
func OrderedCuts(ctx *Context, l, r MySQLRangeCut, typ Type) (MySQLRangeCut, MySQLRangeCut, error) {
...
func SimplifyRangeColumn(ctx *Context, rces ...MySQLRangeColumnExpr) ([]MySQLRangeColumnExpr, error) {
	if len(rces) == 0 {
		return rces, nil
	}
	typ := rces[0].Typ
