...
func (a *AddColumn) Expressions() []sql.Expression {
	return append(sql.WrappedColumnDefaults(a.targetSch), expression.WrapExpressions(a.column.Default)...)
}
...
func (a AddColumn) WithExpressions(exprs ...sql.Expression) (sql.Node, error) {
	...
	a.targetSch = sql.SchemaWithDefaults(a.targetSch, exprs[:len(a.targetSch)])
...
func (d DropColumn) WithExpressions(exprs ...sql.Expression) (sql.Node, error) {
	...
	d.targetSchema = sql.SchemaWithDefaults(d.targetSchema, exprs)
	return &d, nil
}
...
func (r *RenameColumn) Expressions() []sql.Expression {
	return sql.WrappedColumnDefaults(r.targetSchema)
}
...
func (r RenameColumn) WithExpressions(exprs ...sql.Expression) (sql.Node, error) {
	...
	r.targetSchema = sql.SchemaWithDefaults(r.targetSchema, exprs)
	return &r, nil
}
...
func (m *ModifyColumn) Expressions() []sql.Expression {
	return append(sql.WrappedColumnDefaults(m.targetSchema), expression.WrapExpressions(m.column.Default)...)
}
...
func (m ModifyColumn) WithExpressions(exprs ...sql.Expression) (sql.Node, error) {
	...
	m.targetSchema = sql.SchemaWithDefaults(m.targetSchema, exprs[:len(m.targetSchema)])
