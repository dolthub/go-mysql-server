...
func prependRowInPlanForTriggerExecution(row sql.Row) func(c TransformContext) (sql.Node, sql.TreeIdentity, error) {
	return func(c TransformContext) (sql.Node, sql.TreeIdentity, error) {
