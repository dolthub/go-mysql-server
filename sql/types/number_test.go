...
func TestNumberConvert(t *testing.T) {
	...
	tests := []struct {
		...
		{typ: Int32, inp: int64(math.MaxInt32 + 1), exp: int32(math.MaxInt32), err: false, inRange: sql.OutOfRange},
		{typ: Int32, inp: int64(math.MinInt32 - 1), exp: int32(math.MinInt32), err: false, inRange: sql.OutOfRange},
		...
		{typ: Uint32, inp: int64(math.MaxUint32 + 1), exp: uint32(math.MaxUint32), err: false, inRange: sql.OutOfRange},
