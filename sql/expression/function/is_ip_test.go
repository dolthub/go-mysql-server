...
func TestNewIsIPv4Compat(t *testing.T) {
	...
	testCases := []struct {
		...
		{"valid ipv4-compat ipv6 address", sql.NewRow("\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x0a\x00\x01\x0A"), true, false},
		{"valid ipv4-mapped ipv6 address", sql.NewRow("\x00\x00\x00\x00\x00\x00\x00\x00\x00\xff\x00\x00\x0a\x00\x01\x0A"), false, false},
