...
func TestRound(t *testing.T) {
	testCases := []struct {
		...
		{"float64 with blob d", sql.Float64, types.Blob, sql.NewRow(5.855, []byte{1, 2, 3}), float64(5.855), nil},
		...
		{"float32 with blob d", sql.Float32, types.Blob, sql.NewRow(float32(5.855), []byte{1, 2, 3}), float32(5.855), nil},
		...
		{"int32 with blob d", sql.Int32, types.Blob, sql.NewRow(int32(5), []byte{1, 2, 3}), int32(5), nil},
		...
		{"int16 with blob d", sql.Int16, types.Blob, sql.NewRow(int16(5), []byte{1, 2, 3}), int16(5), nil},
		...
		{"int8 with blob d", sql.Int8, types.Blob, sql.NewRow(int8(5), []byte{1, 2, 3}), int8(5), nil},
		...
		{"uint32 with blob d", sql.Uint32, types.Blob, sql.NewRow(uint32(5), []byte{1, 2, 3}), uint32(5), nil},
		...
		{"uint32 with blob d", sql.Uint32, types.Blob, sql.NewRow(uint32(5), []byte{1, 2, 3}), uint32(5), nil},
		{"uint16 with blob d", sql.Uint16, types.Blob, sql.NewRow(uint16(5), []byte{1, 2, 3}), uint16(5), nil},
		...
		{"uint16 with blob d", sql.Uint16, types.Blob, sql.NewRow(uint16(5), []byte{1, 2, 3}), uint16(5), nil},
		{"uint8 with blob d", sql.Uint8, types.Blob, sql.NewRow(uint8(5), []byte{1, 2, 3}), uint8(5), nil},
		...
		{"uint8 with blob d", sql.Uint8, types.Blob, sql.NewRow(uint8(5), []byte{1, 2, 3}), uint8(5), nil},
		{"blob is nil", types.Blob, sql.Int32, sql.NewRow(nil, nil), nil, nil},
		{"blob is ok", types.Blob, sql.Int32, sql.NewRow([]byte{1, 2, 3}, nil), float64(66051), nil},
		{"text int without d", types.Text, sql.Int32, sql.NewRow("5", nil), float64(5), nil},
		{"text int with d", types.Text, sql.Int32, sql.NewRow("5", 2), float64(5), nil},
		{"text int with negative d", types.Text, sql.Int32, sql.NewRow("52", -1), float64(50), nil},
		{"text int with float d", types.Text, sql.Float64, sql.NewRow("5", float32(2.123)), float64(5), nil},
		{"text int with float negative d", types.Text, sql.Float64, sql.NewRow("52", float32(-1)), float64(50), nil},
		{"text float without d", types.Text, sql.Int32, sql.NewRow("5.8", nil), float64(6), nil},
		{"text float with d", types.Text, sql.Int32, sql.NewRow("5.855", 2), float64(5.86), nil},
		{"text float with negative d", types.Text, sql.Int32, sql.NewRow("52.855", -1), float64(50), nil},
		{"text float with float d", types.Text, sql.Float64, sql.NewRow("5.855", float64(2.123)), float64(5.86), nil},
		{"text float with float negative d", types.Text, sql.Float64, sql.NewRow("52.855", float64(-1)), float64(50), nil},
