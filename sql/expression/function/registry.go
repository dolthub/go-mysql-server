...
var BuiltIns = []sql.Function{
	...
	sql.Function1{Name: "st_geomfromtext", Fn: NewGeomFromWKT},
	sql.Function1{Name: "st_geomfromwkb", Fn: NewGeomFromWKB},
	sql.Function1{Name: "st_linefromwkb", Fn: NewLineFromWKB},
	sql.Function1{Name: "st_pointfromwkb", Fn: NewPointFromWKB},
	sql.Function1{Name: "st_polyfromwkb", Fn: NewPolyFromWKB},
	sql.Function1{Name: "st_geomfromwkt", Fn: NewGeomFromWKT},
	sql.Function1{Name: "st_linefromwkt", Fn: NewLineFromWKT},
	sql.Function1{Name: "st_pointfromwkt", Fn: NewPointFromWKT},
	sql.Function1{Name: "st_polyfromwkt", Fn: NewPolyFromWKT},
