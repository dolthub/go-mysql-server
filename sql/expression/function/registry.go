...
var BuiltIns = []sql.Function{
	...
	sql.Function1{Name: "is_ipv4", Fn: NewIsIP4},
	sql.Function1{Name: "is_ipv4_compat", Fn: NewIsIP4Compat},
	sql.Function1{Name: "is_ipv4_mapped", Fn: NewIsIP4Mapped},
	sql.Function1{Name: "is_ipv6", Fn: NewIsIP6},
