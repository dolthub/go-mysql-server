...
var BuiltIns = []sql.Function{
	...
	sql.Function1{Name: "st_area", Fn: NewArea},
	...
	sql.FunctionN{Name: "st_geomcollfromtext", Fn: NewGeomCollFromText},
	sql.FunctionN{Name: "st_geomcollfromtxt", Fn: NewGeomCollFromText},
	...
	sql.FunctionN{Name: "st_geometrycollectionfromtext", Fn: NewGeomCollFromText},
	...
	sql.FunctionN{Name: "st_geometryfromwkb", Fn: NewGeomFromWKB},
	sql.FunctionN{Name: "st_geomfromwkb", Fn: NewGeomFromWKB},
	sql.FunctionN{Name: "st_length", Fn: NewSTLength},
	sql.FunctionN{Name: "st_longitude", Fn: NewLongitude},
	sql.FunctionN{Name: "st_linefromtext", Fn: NewLineFromText},
	sql.FunctionN{Name: "st_linefromwkb", Fn: NewLineFromWKB},
	sql.FunctionN{Name: "st_linestringfromtext", Fn: NewLineFromText},
	sql.FunctionN{Name: "st_linestringfromwkb", Fn: NewLineFromWKB},
	sql.FunctionN{Name: "st_mlinefromtext", Fn: NewMLineFromText},
	sql.FunctionN{Name: "st_mlinefromwkb", Fn: NewMLineFromWKB},
	sql.FunctionN{Name: "st_multilinestringfromtext", Fn: NewLineFromText},
	sql.FunctionN{Name: "st_multilinestringfromwkb", Fn: NewMLineFromWKB},
	sql.FunctionN{Name: "st_mpointfromtext", Fn: NewMPointFromText},
	...
	sql.FunctionN{Name: "st_mpolyfromtext", Fn: NewMPolyFromText},
	sql.FunctionN{Name: "st_multipolygonfromwkb", Fn: NewMPolyFromWKB},
	sql.FunctionN{Name: "st_multipolygonfromtext", Fn: NewMPolyFromText},
	...
	sql.FunctionN{Name: "st_polyfromtext", Fn: NewPolyFromText},
	sql.FunctionN{Name: "st_polyfromwkb", Fn: NewPolyFromWKB},
	sql.FunctionN{Name: "st_polygonfromtext", Fn: NewPolyFromText},
	sql.FunctionN{Name: "st_polygonfromwkb", Fn: NewPolyFromWKB},
