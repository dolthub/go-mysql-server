...
func TestTimestampDiff(t *testing.T) {
	testCases := []struct {
		...
		{"year - second less than a year, same year", types.Text, types.Text, types.Text, sql.NewRow("YEAR", "2019-01-01 00:00:00", "2019-12-31 23:59:59"), int64(0), false},
		{"year - second less than five years", types.Text, types.Text, types.Text, sql.NewRow("YEAR", "2016-09-04 00:00:01", "2021-09-04 00:00:00"), int64(4), false},
