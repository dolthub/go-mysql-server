...
func TestPrefixKey(t *testing.T) {
	tests := []struct {
		...
		expBuckets       int
		expRowCount      float64
		expDistinctCount float64
		expNullCount     float64
	}{
		{
			name:             "x_1 nil key",
			statistic:        x1Stat,
			pref:             []interface{}{nil},
			expBuckets:       3,
			expRowCount:      float64(15),
			expDistinctCount: float64(3),
			expNullCount:     float64(10),
		},
		{
			name:             "x_1 (2) key",
			statistic:        x1Stat,
			pref:             []interface{}{2},
			expBuckets:       1,
			expRowCount:      float64(5),
			expDistinctCount: float64(1),
			expNullCount:     float64(0),
		},
		{
			name:             "x_1 (5) key",
			statistic:        x1Stat,
		...
		},
		{
			...
			pref:             []interface{}{20},
			expBuckets:       2,
			expRowCount:      float64(10),
			expDistinctCount: float64(2),
			expNullCount:     float64(0),
		},
		{
			name:             "x_1 (21) key",
			...
			pref:             []interface{}{21},
			expBuckets:       0,
			expRowCount:      float64(0),
			expDistinctCount: float64(0),
			expNullCount:     float64(0),
		},
		// x2
		{
		...
		// xy1
		{
			...
			pref:             []interface{}{nil},
			expBuckets:       7,
			expRowCount:      float64(35),
			expDistinctCount: float64(7),
			expNullCount:     float64(35),
		},
		{
			name:             "xy_1 (1) key",
			statistic:        xy1Stat,
			pref:             []interface{}{1},
			expBuckets:       6,
			expRowCount:      float64(30),
			expDistinctCount: float64(6),
			expNullCount:     float64(10),
		},
		{
			name:             "xy_1 (2) key",
		...
		// xy2
		{
			...
			pref:             []interface{}{nil},
			expBuckets:       4,
			expRowCount:      float64(20),
			expDistinctCount: float64(7),
			expNullCount:     float64(20),
		},
		{
			name:             "xy_2 (2) key",
			statistic:        xy2Stat,
...
func TestUpdateCounts(t *testing.T) {
	tests := []struct {
		...
		{
			vals: []float64{1, 1, 1, 4, 1},
			exp:  float64(8),
		},
		{
			vals: []float64{1000, 1, 1, 4, 1},
			exp:  float64(1007),
		},
	}
	...
	for _, tt := range tests {
		...
		for i := range buckets {
			buckets[i] = &Bucket{RowCnt: float64(tt.vals[i]), DistinctCnt: float64(tt.vals[i]), NullCnt: float64(tt.vals[i])}
		}
