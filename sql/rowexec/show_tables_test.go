...
func TestShowTables(t *testing.T) {
	...
	db.AddTable("test1", memory.NewTable(ctx, db, "test1", sql.PrimaryKeySchema{}, db.GetForeignKeyCollection()))
	db.AddTable("test2", memory.NewTable(ctx, db, "test2", sql.PrimaryKeySchema{}, db.GetForeignKeyCollection()))
	db.AddTable("test3", memory.NewTable(ctx, db, "test3", sql.PrimaryKeySchema{}, db.GetForeignKeyCollection()))
