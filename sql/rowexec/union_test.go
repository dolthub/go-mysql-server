...
func TestUnion(t *testing.T) {
	...
	cases := []struct {
		...
		{
			plan.NewUnion(plan.UnionType, plan.NewProject(name, plan.NewResolvedTable(child, nil, nil)), plan.NewProject(name, plan.NewResolvedTable(child, nil, nil)), false, nil, nil, nil),
			[]string{
		...
		{
			plan.NewUnion(plan.UnionType, plan.NewProject(name, plan.NewResolvedTable(empty, nil, nil)), plan.NewProject(name, plan.NewResolvedTable(child, nil, nil)), false, nil, nil, nil),
			[]string{
				"john", "jane", "john", "martha", "martha",
			},
		},
		{
			plan.NewUnion(plan.UnionType, plan.NewProject(name, plan.NewResolvedTable(child, nil, nil)), plan.NewProject(name, plan.NewResolvedTable(empty, nil, nil)), false, nil, nil, nil),
			[]string{
				"john", "jane", "john", "martha", "martha",
			},
		},
