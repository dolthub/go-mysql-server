...
`,
		ExpectedPlan: "Project\n" +
			...
			"     │           └─ IndexedTableAccess(asset)\n" +
			"     │               ├─ index: [asset.orgId,asset.name,asset.assetId]\n" +
			"     │               ├─ keys: [org1 (longtext) style (longtext) color.assetId:1]\n" +
			"     │               ├─ colSet: (1-5)\n" +
			"     │               ├─ tableId: 1\n" +
			"     │               └─ Table\n" +
			"     │                   ├─ name: asset\n" +
			...
			"             └─ IndexedTableAccess(asset)\n" +
			"                 ├─ index: [asset.orgId,asset.name,asset.assetId]\n" +
			"                 ├─ keys: [org1 (longtext) dimension (longtext) style.assetId:5]\n" +
			"                 ├─ colSet: (6-10)\n" +
			"                 ├─ tableId: 2\n" +
			"                 └─ Table\n" +
			"                     ├─ name: asset\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"                 │                       ├─ keys: [parts.part:0!null crust (longtext)]\n" +
			"                 │                       ├─ colSet: (4-6)\n" +
			"                 │                       ├─ tableId: 2\n" +
			"                 │                       └─ Table\n" +
			"                 │                           ├─ name: parts\n" +
...
`,
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"     │               └─ columns: [i s]\n" +
			"     └─ HashLookup\n" +
			"         ├─ left-key: TUPLE(t1.i:2!null, t1.s:3!null, t3.i2:1!null)\n" +
			"         ├─ right-key: TUPLE(t2.i:0!null, t2.s:1!null, t2.i:0!null)\n" +
			"         └─ TableAlias(t2)\n" +
			"             └─ ProcessTable\n" +
			"                 └─ Table\n" +
			"                     ├─ name: mytable\n" +
...
`,
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"         │               └─ columns: [i s]\n" +
			"         └─ HashLookup\n" +
			"             ├─ left-key: TUPLE(a.i:2!null, b.i:1!null)\n" +
			"             ├─ right-key: TUPLE(d.i:0!null, d.i:0!null)\n" +
			"             └─ TableAlias(d)\n" +
			"                 └─ ProcessTable\n" +
			"                     └─ Table\n" +
			"                         ├─ name: mytable\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"     │               └─ tableId: 1\n" +
			"     └─ HashLookup\n" +
			"         ├─ left-key: TUPLE(a.i:2!null, c.i:1!null)\n" +
			"         ├─ right-key: TUPLE(b.i:0!null, b.i:0!null)\n" +
			"         └─ TableAlias(b)\n" +
			"             └─ Table\n" +
			"                 ├─ name: mytable\n" +
			"                 ├─ columns: [i]\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"     │   │               └─ columns: [i s]\n" +
			"     │   └─ HashLookup\n" +
			"     │       ├─ left-key: TUPLE(a.i:1!null, c.i:0!null)\n" +
			"     │       ├─ right-key: TUPLE(b.i:0!null, b.i:0!null)\n" +
			"     │       └─ TableAlias(b)\n" +
			"     │           └─ ProcessTable\n" +
			"     │               └─ Table\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"     │           └─ columns: [i date_col datetime_col timestamp_col time_col]\n" +
			"     └─ HashLookup\n" +
			"         ├─ left-key: TUPLE(dt2.timestamp_col:3)\n" +
			"         ├─ right-key: TUPLE(dt1.timestamp_col:3)\n" +
			"         └─ TableAlias(dt1)\n" +
			"             └─ Table\n" +
			"                 ├─ name: datetime_table\n" +
			"                 ├─ columns: [i date_col datetime_col timestamp_col time_col]\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"     └─ HashLookup\n" +
			"         ├─ left-key: TUPLE(dt2.timestamp_col:3)\n" +
			"         ├─ right-key: TUPLE(dt1.date_col:1)\n" +
			"         └─ TableAlias(dt1)\n" +
			"             └─ Table\n" +
			"                 ├─ name: datetime_table\n" +
			"                 ├─ columns: [i date_col datetime_col timestamp_col time_col]\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"     └─ HashLookup\n" +
			"         ├─ left-key: TUPLE(dt2.timestamp_col:3)\n" +
			"         ├─ right-key: TUPLE(dt1.datetime_col:2)\n" +
			"         └─ TableAlias(dt1)\n" +
			"             └─ Table\n" +
			"                 ├─ name: datetime_table\n" +
			"                 ├─ columns: [i date_col datetime_col timestamp_col time_col]\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"             │           └─ columns: [i date_col datetime_col timestamp_col time_col]\n" +
			"             └─ HashLookup\n" +
			"                 ├─ left-key: TUPLE(DATE(date_sub(dt2.timestamp_col,INTERVAL 2 DAY)))\n" +
			"                 ├─ right-key: TUPLE(dt1.date_col:1)\n" +
			"                 └─ TableAlias(dt1)\n" +
			"                     └─ Table\n" +
			"                         ├─ name: datetime_table\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"     └─ Project\n" +
			"         ├─ columns: [one_pk.pk:0!null, one_pk.c1:1, one_pk.c2:2, one_pk.c3:3, one_pk.c4:4, one_pk.c5:5, tpk.pk1:13!null, tpk.pk2:14!null, tpk.c1:15!null, tpk.c2:16!null, tpk.c3:17!null, tpk.c4:18!null, tpk.c5:19!null, tpk2.pk1:6!null, tpk2.pk2:7!null, tpk2.c1:8!null, tpk2.c2:9!null, tpk2.c3:10!null, tpk2.c4:11!null, tpk2.c5:12!null]\n" +
			"         └─ LookupJoin\n" +
			"             ├─ Eq\n" +
			"             │   ├─ tpk.pk1:13!null\n" +
			"             │   └─ tpk2.pk2:7!null\n" +
			...
			"             │       └─ IndexedTableAccess(two_pk)\n" +
			"             │           ├─ index: [two_pk.pk1,two_pk.pk2]\n" +
			"             │           ├─ keys: [(one_pk.pk:0!null - 1 (tinyint)) one_pk.pk:0!null]\n" +
			"             │           ├─ colSet: (14-20)\n" +
			"             │           ├─ tableId: 3\n" +
			"             │           └─ Table\n" +
			"             │               ├─ name: two_pk\n" +
			...
			"                 └─ IndexedTableAccess(two_pk)\n" +
			"                     ├─ index: [two_pk.pk1,two_pk.pk2]\n" +
			"                     ├─ keys: [one_pk.pk:0!null (one_pk.pk:0!null - 1 (tinyint))]\n" +
			"                     ├─ colSet: (7-13)\n" +
			"                     ├─ tableId: 2\n" +
			"                     └─ Table\n" +
			"                         ├─ name: two_pk\n" +
	...
	},
	{
		...
		ExpectedPlan: "LookupJoin\n" +
			...
			" └─ IndexedTableAccess(two_pk)\n" +
			"     ├─ index: [two_pk.pk1,two_pk.pk2]\n" +
			"     ├─ keys: [(mytable.i:0!null - 1 (tinyint)) (mytable.i:0!null - 2 (tinyint))]\n" +
			"     ├─ colSet: (3-9)\n" +
			"     ├─ tableId: 2\n" +
			"     └─ Table\n" +
			"         ├─ name: two_pk\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"                 └─ IndexedTableAccess(two_pk)\n" +
			"                     ├─ index: [two_pk.pk1,two_pk.pk2]\n" +
			"                     ├─ keys: [b.pk2:1!null b.pk1:0!null]\n" +
			"                     ├─ colSet: (1-7)\n" +
			"                     ├─ tableId: 1\n" +
			"                     └─ Table\n" +
			"                         ├─ name: two_pk\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"     │           └─ columns: [z]\n" +
			"     └─ HashLookup\n" +
			"         ├─ left-key: TUPLE(b.z:0!null)\n" +
			"         ├─ right-key: TUPLE(a.y:1!null)\n" +
			"         └─ TableAlias(a)\n" +
			"             └─ Table\n" +
			"                 ├─ name: invert_pk\n" +
			"                 ├─ columns: [x y z]\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"             │   │       └─ tableId: 2\n" +
			"             │   └─ HashLookup\n" +
			"             │       ├─ left-key: TUPLE((b.i:1!null + 1 (tinyint)))\n" +
			"             │       ├─ right-key: TUPLE(a.i:0!null)\n" +
			"             │       └─ TableAlias(a)\n" +
			"             │           └─ Table\n" +
			"             │               ├─ name: mytable\n" +
			...
			"             │               └─ tableId: 1\n" +
			"             └─ HashLookup\n" +
			"                 ├─ left-key: TUPLE(a.i:2!null)\n" +
			"                 ├─ right-key: TUPLE((c.i:0!null - 1 (tinyint)))\n" +
			"                 └─ TableAlias(c)\n" +
			"                     └─ Table\n" +
			"                         ├─ name: mytable\n" +
			"                         ├─ columns: [i]\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"     │   │   │           └─ columns: [s2 i2]\n" +
			"     │   │   └─ HashLookup\n" +
			"     │   │       ├─ left-key: TUPLE((b.i2:1!null + 1 (tinyint)))\n" +
			"     │   │       ├─ right-key: TUPLE(a.i:0!null)\n" +
			"     │   │       └─ TableAlias(a)\n" +
			"     │   │           └─ ProcessTable\n" +
			"     │   │               └─ Table\n" +
			...
			"     │               └─ tableId: 3\n" +
			"     └─ HashLookup\n" +
			"         ├─ left-key: TUPLE(b.i2:1!null)\n" +
			"         ├─ right-key: TUPLE(d.i2:0!null)\n" +
			"         └─ TableAlias(d)\n" +
			"             └─ Table\n" +
			"                 ├─ name: othertable\n" +
			"                 ├─ columns: [i2]\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			"     │           │           └─ columns: [s2 i2]\n" +
			"     │           └─ HashLookup\n" +
			"     │               ├─ left-key: TUPLE((b.i2:2!null + 1 (tinyint)))\n" +
			"     │               ├─ right-key: TUPLE(a.i:0!null)\n" +
			"     │               └─ TableAlias(a)\n" +
			"     │                   └─ Table\n" +
			"     │                       ├─ name: mytable\n" +
  ...
  select * from (
    ...
    On b.I = e.i
		...
		ExpectedPlan: "SubqueryAlias\n" +
			...
			"             │               └─ columns: [i s]\n" +
			"             └─ HashLookup\n" +
			"                 ├─ left-key: TUPLE(a.i:2!null, e.i:0!null)\n" +
			"                 ├─ right-key: TUPLE(b.i:0!null, b.I:0!null)\n" +
			"                 └─ SubqueryAlias\n" +
			"                     ├─ name: b\n" +
			"                     ├─ outerVisibility: false\n" +
	...
	},
	{
		...
		ExpectedPlan: "SubqueryAlias\n" +
			...
			"                 └─ Project\n" +
			"                     ├─ columns: [a.pk:2!null, a.c1:3, a.c2:4, a.c3:5, a.c4:6, a.c5:7, b.i:0!null, b.s:1!null]\n" +
			"                     └─ CrossHashJoin\n" +
			"                         ├─ TableAlias(b)\n" +
			"                         │   └─ Table\n" +
			"                         │       ├─ name: mytable\n" +
