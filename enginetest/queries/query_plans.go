...
;`,
	...
	GROUP BY T4IBQ, ECUWU`,
		ExpectedPlan: "Project\n" +
			...
			"                                                     │               │   │           │           └─ columns: [id ftqlq]\n" +
			"                                                     │               │   │           └─ HashLookup\n" +
			"                                                     │               │   │               ├─ to: TUPLE(cla.id:0!null)\n" +
			"                                                     │               │   │               ├─ from: TUPLE(bs.IXUXU:1)\n" +
			"                                                     │               │   │               └─ CachedResults\n" +
			"                                                     │               │   │                   └─ LookupJoin\n" +
			"                                                     │               │   │                       ├─ Eq\n" +
			"                                                     │               │   │                       │   ├─ sn.BRQP2:12!null\n" +
...
FROM
    ...
    WHERE
		...
		ExpectedPlan: "TriggerRollback\n" +
			...
			"             │                       └─ HashLookup\n" +
			"             │                           ├─ to: TUPLE(sn.id:2!null, SKPM6.id:0!null)\n" +
			"             │                           ├─ from: TUPLE(rn.WNUNU:0!null, rn.HHVLX:1!null)\n" +
			"             │                           └─ CachedResults\n" +
			"             │                               └─ TableAlias(rn)\n" +
			"             │                                   └─ Table\n" +
			"             │                                       ├─ name: QYWQD\n" +
