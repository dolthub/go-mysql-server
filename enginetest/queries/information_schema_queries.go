		...
		Assertions: []ScriptTestAssertion{
			{
				...
				Expected: []sql.Row{
					...
					{"about", "date_created", nil, "YES", "timestamp(0)", "", nil, ""},
					{"about", "date_updated", nil, "YES", "timestamp(0)", "", nil, ""},
...
FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='mydb' AND TABLE_NAME='all_types' ORDER BY ORDINAL_POSITION`,
				Expected: []sql.Row{
					...
					{"date_time", "2022-02-22 22:22:21", "YES", "datetime", "datetime(0)", nil, nil},
					...
					{"time_stamp", "CURRENT_TIMESTAMP", "YES", "timestamp", "timestamp(0)", nil, nil},
...
FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='mydb' AND TABLE_NAME='all_types' ORDER BY ORDINAL_POSITION`,
				Expected: []sql.Row{
					...
					{"date_time", "datetime(0)", nil, nil, 0, nil, nil, "", "", "", "", nil},
					...
					{"time_stamp", "timestamp(0)", nil, nil, 0, nil, nil, "", "DEFAULT_GENERATED", "", "", nil},
