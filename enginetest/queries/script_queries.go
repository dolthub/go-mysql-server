...
`,
	...
	},
	{
		...
		SetUpScript: []string{
			...
			"CREATE TABLE t35 (a35 INTEGER PRIMARY KEY, b35 INTEGER, x35 VARCHAR(40));",
			...
			"CREATE TABLE t37 (a37 INTEGER PRIMARY KEY, b37 INTEGER, x37 VARCHAR(40));",
			...
			"CREATE TABLE t38 (a38 INTEGER PRIMARY KEY, b38 INTEGER, x38 VARCHAR(40));",
			...
			"CREATE TABLE t39 (a39 INTEGER PRIMARY KEY, b39 INTEGER, x39 VARCHAR(40));",
			...
			"CREATE TABLE t40 (a40 INTEGER PRIMARY KEY, b40 INTEGER, x40 VARCHAR(40));",
			...
			"CREATE TABLE t41 (a41 INTEGER PRIMARY KEY, b41 INTEGER, x41 VARCHAR(40));",
			...
			"CREATE TABLE t42 (a42 INTEGER PRIMARY KEY, b42 INTEGER, x42 VARCHAR(40));",
			...
			"CREATE TABLE t43 (a43 INTEGER PRIMARY KEY, b43 INTEGER, x43 VARCHAR(40));",
			...
			"CREATE TABLE t45 (a45 INTEGER PRIMARY KEY, b45 INTEGER, x45 VARCHAR(40));",
			...
			"CREATE TABLE t46 (a46 INTEGER PRIMARY KEY, b46 INTEGER, x46 VARCHAR(40));",
			...
			"CREATE TABLE t47 (a47 INTEGER PRIMARY KEY, b47 INTEGER, x47 VARCHAR(40));",
			...
			"CREATE TABLE t49 (a49 INTEGER PRIMARY KEY, b49 INTEGER, x49 VARCHAR(40));",
			...
			"CREATE TABLE t50 (a50 INTEGER PRIMARY KEY, b50 INTEGER, x50 VARCHAR(40));",
			...
			"CREATE TABLE t52 (a52 INTEGER PRIMARY KEY, b52 INTEGER, x52 VARCHAR(40));",
			...
			"CREATE TABLE t53 (a53 INTEGER PRIMARY KEY, b53 INTEGER, x53 VARCHAR(40));",
			...
			"CREATE TABLE t54 (a54 INTEGER PRIMARY KEY, b54 INTEGER, x54 VARCHAR(40));",
			...
			"CREATE TABLE t56 (a56 INTEGER PRIMARY KEY, b56 INTEGER, x56 VARCHAR(40));",
			...
			"CREATE TABLE t58 (a58 INTEGER PRIMARY KEY, b58 INTEGER, x58 VARCHAR(40));",
			...
			"CREATE TABLE t59 (a59 INTEGER PRIMARY KEY, b59 INTEGER, x59 VARCHAR(40));",
			...
			"CREATE TABLE t60 (a60 INTEGER PRIMARY KEY, b60 INTEGER, x60 VARCHAR(40));",
			...
			"CREATE TABLE t61 (a61 INTEGER PRIMARY KEY, b61 INTEGER, x61 VARCHAR(40));",
			...
			"CREATE TABLE t62 (a62 INTEGER PRIMARY KEY, b62 INTEGER, x62 VARCHAR(40));",
			...
			"CREATE TABLE t63 (a63 INTEGER PRIMARY KEY, b63 INTEGER, x63 VARCHAR(40));",
			...
			"CREATE TABLE t64 (a64 INTEGER PRIMARY KEY, b64 INTEGER, x64 VARCHAR(40));",
...
`,
			...
			},
			{
				Query: `
SELECT 
    x56,x43,x12,x9,x61,x50,x45,x58,x18,x47,x1,x17,x29,x2,x5
FROM 
    t17,t56,t43,t5,t2,t50,t12,t58,t29,t1,t9,t47,t61,t18,t45
WHERE
    5   = a2  AND
    b18 = a2  AND
    b56 = a18 AND
