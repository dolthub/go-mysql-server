...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(n.name:7!null), MIN(t.title:18!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(n.name:9!null), MIN(pi.info:14!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
