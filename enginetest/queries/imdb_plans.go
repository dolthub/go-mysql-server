...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(chn.name:11!null), MIN(t.title:15!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
			...
			"             │       │   └─ actor (longtext)\n" +
			"             │       └─ TableAlias(rt)\n" +
			"             │           └─ IndexedTableAccess(role_type)\n" +
			"             │               ├─ index: [role_type.id]\n" +
			"             │               ├─ keys: [ci.role_id:9!null]\n" +
			"             │               ├─ colSet: (29,30)\n" +
			"             │               ├─ tableId: 6\n" +
			"             │               └─ Table\n" +
			"             │                   ├─ name: role_type\n" +
	...
	},
	{
		...
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(chn.name:11!null), MIN(t.title:14!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(cn.name:5!null), MIN(lt.link:16!null), MIN(t.title:18!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"                 │       ├─ lt.link LIKE '%follow%'\n" +
			"                 │       └─ TableAlias(lt)\n" +
			"                 │           └─ IndexedTableAccess(link_type)\n" +
			"                 │               ├─ index: [link_type.id]\n" +
			"                 │               ├─ keys: [ml.link_type_id:14!null]\n" +
			"                 │               ├─ colSet: (13,14)\n" +
			"                 │               ├─ tableId: 4\n" +
			"                 │               └─ Table\n" +
			"                 │                   ├─ name: link_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(cn.name:5!null), MIN(mc.note:3), MIN(t.title:17!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(cn.name:4!null), MIN(mi_idx.info:15!null), MIN(t.title:19!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"                 │           └─ IndexedTableAccess(info_type)\n" +
			"                 │               ├─ index: [info_type.id]\n" +
			"                 │               ├─ keys: [mi_idx.info_type_id:14!null]\n" +
			"                 │               ├─ colSet: (12,13)\n" +
			"                 │               ├─ tableId: 4\n" +
			"                 │               └─ Table\n" +
			"                 │                   ├─ name: info_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:9!null), MIN(t.title:17!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"                 │           └─ IndexedTableAccess(info_type)\n" +
			"                 │               ├─ index: [info_type.id]\n" +
			"                 │               ├─ keys: [mi_idx.info_type_id:13!null]\n" +
			"                 │               ├─ colSet: (12,13)\n" +
			"                 │               ├─ tableId: 4\n" +
			"                 │               └─ Table\n" +
			"                 │                   ├─ name: info_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:2!null), MIN(miidx.info:7!null), MIN(t.title:18!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"             │           └─ IndexedTableAccess(info_type)\n" +
			"             │               ├─ index: [info_type.id]\n" +
			"             │               ├─ keys: [miidx.info_type_id:6!null]\n" +
			"             │               ├─ colSet: (10,11)\n" +
			"             │               ├─ tableId: 3\n" +
			"             │               └─ Table\n" +
			"             │                   ├─ name: info_type\n" +
			...
			"                 │   │           └─ IndexedTableAccess(company_type)\n" +
			"                 │   │               ├─ index: [company_type.id]\n" +
			"                 │   │               ├─ keys: [mc.company_type_id:12!null]\n" +
			"                 │   │               ├─ colSet: (8,9)\n" +
			"                 │   │               ├─ tableId: 2\n" +
			"                 │   │               └─ Table\n" +
			"                 │   │                   ├─ name: company_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(cn.name:13!null), MIN(miidx.info:6!null), MIN(t.title:18!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"             │           └─ IndexedTableAccess(info_type)\n" +
			"             │               ├─ index: [info_type.id]\n" +
			"             │               ├─ keys: [miidx.info_type_id:5!null]\n" +
			"             │               ├─ colSet: (10,11)\n" +
			"             │               ├─ tableId: 3\n" +
			"             │               └─ Table\n" +
			"             │                   ├─ name: info_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi_idx.info:2!null), MIN(t.title:15!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"         │           └─ IndexedTableAccess(info_type)\n" +
			"         │               ├─ index: [info_type.id]\n" +
			"         │               ├─ keys: [mi_idx.info_type_id:1!null]\n" +
			"         │               ├─ colSet: (3,4)\n" +
			"         │               ├─ tableId: 2\n" +
			"         │               └─ Table\n" +
			"         │                   ├─ name: info_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:10!null), MIN(t.title:18!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"             │       └─ IndexedTableAccess(company_type)\n" +
			"             │           ├─ index: [company_type.id]\n" +
			"             │           ├─ keys: [mc.company_type_id:3!null]\n" +
			"             │           ├─ colSet: (20,21)\n" +
			"             │           ├─ tableId: 3\n" +
			"             │           └─ Table\n" +
			"             │               ├─ name: company_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:11!null), MIN(t.title:19!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			"             │       └─ IndexedTableAccess(company_type)\n" +
			"             │           ├─ index: [company_type.id]\n" +
			"             │           ├─ keys: [mc.company_type_id:4!null]\n" +
			"             │           ├─ colSet: (20,21)\n" +
			"             │           ├─ tableId: 3\n" +
			"             │           └─ Table\n" +
			"             │               ├─ name: company_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(an.name:11!null), MIN(t.title:14!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:2!null), MIN(mi_idx.info:7!null), MIN(t.title:17!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"             │           └─ IndexedTableAccess(info_type)\n" +
			"             │               ├─ index: [info_type.id]\n" +
			"             │               ├─ keys: [mi_idx.info_type_id:6!null]\n" +
			"             │               ├─ colSet: (10,11)\n" +
			"             │               ├─ tableId: 3\n" +
			"             │               └─ Table\n" +
			"             │                   ├─ name: info_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			" ├─ columns: [min(mi.info):0!null as movie_budget, min(mi_idx.info):1!null as movie_votes, min(t.title):2!null as movie_title]\n" +
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:2!null), MIN(mi_idx.info:8!null), MIN(t.title:17!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"             │           └─ IndexedTableAccess(info_type)\n" +
			"             │               ├─ index: [info_type.id]\n" +
			"             │               ├─ keys: [mi_idx.info_type_id:7!null]\n" +
			"             │               ├─ colSet: (10,11)\n" +
			"             │               ├─ tableId: 3\n" +
			"             │               └─ Table\n" +
			"             │                   ├─ name: info_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			" ├─ columns: [min(mi.info):0!null as movie_budget, min(mi_idx.info):1!null as movie_votes, min(t.title):2!null as movie_title]\n" +
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:2!null), MIN(mi_idx.info:7!null), MIN(t.title:16!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mc.note:2), MIN(t.production_year:11), MIN(t.title:10!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
			...
			"         │           └─ IndexedTableAccess(company_type)\n" +
			"         │               ├─ index: [company_type.id]\n" +
			"         │               ├─ keys: [mc.company_type_id:1!null]\n" +
			"         │               ├─ colSet: (1,2)\n" +
			"         │               ├─ tableId: 1\n" +
			"         │               └─ Table\n" +
			"         │                   ├─ name: company_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			"         │   │       └─ TableAlias(cct2)\n" +
			"         │   │           └─ IndexedTableAccess(comp_cast_type)\n" +
			"         │   │               ├─ index: [comp_cast_type.id]\n" +
			"         │   │               ├─ keys: [cc.status_id:2!null]\n" +
			"         │   │               ├─ colSet: (7,8)\n" +
			"         │   │               ├─ tableId: 3\n" +
			"         │   │               └─ Table\n" +
			"         │   │                   ├─ name: comp_cast_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(n.name:17!null), MIN(t.title:19!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(cn.name:5!null), MIN(lt.link:18!null), MIN(t.title:20!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(cn.name:19!null), MIN(mi_idx.info:7!null), MIN(t.title:23!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"                     │   │       └─ IndexedTableAccess(company_type)\n" +
			"                     │   │           ├─ index: [company_type.id]\n" +
			"                     │   │           ├─ keys: [mc.company_type_id:16!null]\n" +
			"                     │   │           ├─ colSet: (8,9)\n" +
			"                     │   │           ├─ tableId: 2\n" +
			"                     │   │           └─ Table\n" +
			"                     │   │               ├─ name: company_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			" ├─ columns: [min(cn.name):0!null as movie_company, min(mi_idx.info):1!null as rating, min(t.title):2!null as western_violent_movie]\n" +
			" └─ GroupBy\n" +
			"     ├─ select: MIN(cn.name:18!null), MIN(mi_idx.info:7!null), MIN(t.title:22!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(kt.kind:24!null), MIN(t.title:20!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(kt.kind:25!null), MIN(t.title:21!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(chn.name:20!null), MIN(n.name:22!null), MIN(t.title:27!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(chn.name:21!null), MIN(n.name:23!null), MIN(t.title:28!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:2!null), MIN(mi_idx.info:7!null), MIN(n.name:18!null), MIN(t.title:21!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(chn.name:20!null), MIN(mi_idx.info:9!null), MIN(n.name:22!null), MIN(t.title:24!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"             │           └─ IndexedTableAccess(info_type)\n" +
			"             │               ├─ index: [info_type.id]\n" +
			"             │               ├─ keys: [mi_idx.info_type_id:8!null]\n" +
			"             │               ├─ colSet: (23,24)\n" +
			"             │               ├─ tableId: 6\n" +
			"             │               └─ Table\n" +
			"             │                   ├─ name: info_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(chn.name:20!null), MIN(mi_idx.info:9!null), MIN(t.title:23!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(cn.name:12!null), MIN(lt.link:25!null), MIN(t.title:27!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"             │           └─ IndexedTableAccess(company_type)\n" +
			"             │               ├─ index: [company_type.id]\n" +
			"             │               ├─ keys: [mc.company_type_id:9!null]\n" +
			"             │               ├─ colSet: (16,17)\n" +
			"             │               ├─ tableId: 5\n" +
			"             │               └─ Table\n" +
			"             │                   ├─ name: company_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(cn.name:5!null), MIN(mi_idx.info:15!null), MIN(t.title:30!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:9!null), MIN(mi_idx.info:14!null), MIN(n.name:25!null), MIN(t.title:28!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:6!null), MIN(mi_idx.info:11!null), MIN(n.name:22!null), MIN(t.title:25!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"                 │           └─ IndexedTableAccess(info_type)\n" +
			"                 │               ├─ index: [info_type.id]\n" +
			"                 │               ├─ keys: [mi_idx.info_type_id:10!null]\n" +
			"                 │               ├─ colSet: (17,18)\n" +
			"                 │               ├─ tableId: 4\n" +
			"                 │               └─ Table\n" +
			"                 │                   ├─ name: info_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			" ├─ columns: [min(mi.info):0!null as movie_budget, min(mi_idx.info):1!null as movie_votes, min(n.name):2!null as writer, min(t.title):3!null as violent_liongate_movie]\n" +
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:7!null), MIN(mi_idx.info:12!null), MIN(n.name:23!null), MIN(t.title:26!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			" ├─ columns: [min(mi.info):0!null as movie_budget, min(mi_idx.info):1!null as movie_votes, min(n.name):2!null as writer, min(t.title):3!null as violent_liongate_movie]\n" +
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi.info:6!null), MIN(mi_idx.info:11!null), MIN(n.name:22!null), MIN(t.title:24!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(lt.link:8!null), MIN(t1.title:12!null), MIN(t2.title:10!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			...
			"             │       └─ IndexedTableAccess(title)\n" +
			"             │           ├─ index: [title.id]\n" +
			"             │           ├─ keys: [ml.linked_movie_id:5!null]\n" +
			"             │           ├─ colSet: (25-36)\n" +
			"             │           ├─ tableId: 6\n" +
			"             │           └─ Table\n" +
			"             │               ├─ name: title\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(cn1.name:18!null), MIN(cn2.name:28!null), MIN(mi_idx1.info:2!null), MIN(mi_idx2.info:7!null), MIN(t1.title:21!null), MIN(t2.title:30!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ AND\n" +
			"         │   │   ├─ Eq\n" +
			"         │   │   │   ├─ mi_idx1.movie_id:0!null\n" +
			...
			"         │           └─ IndexedTableAccess(info_type)\n" +
			"         │               ├─ index: [info_type.id]\n" +
			"         │               ├─ keys: [mi_idx1.info_type_id:1!null]\n" +
			"         │               ├─ colSet: (15,16)\n" +
			"         │               ├─ tableId: 3\n" +
			"         │               └─ Table\n" +
			"         │                   ├─ name: info_type\n" +
			...
			"             ├─ AND\n" +
			"             │   ├─ Eq\n" +
			"             │   │   ├─ mi_idx2.movie_id:5!null\n" +
			"             │   │   └─ mc2.movie_id:25!null\n" +
			"             │   └─ Eq\n" +
			"             │       ├─ ml.linked_movie_id:11!null\n" +
			"             │       └─ mi_idx2.movie_id:5!null\n" +
			"             ├─ LookupJoin\n" +
			"             │   ├─ Filter\n" +
			"             │   │   ├─ LessThan\n" +
			...
			"             │           └─ IndexedTableAccess(info_type)\n" +
			"             │               ├─ index: [info_type.id]\n" +
			"             │               ├─ keys: [mi_idx2.info_type_id:6!null]\n" +
			"             │               ├─ colSet: (17,18)\n" +
			"             │               ├─ tableId: 4\n" +
			"             │               └─ Table\n" +
			"             │                   ├─ name: info_type\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(mi_idx.info:2!null), MIN(t.title:10!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(n.name:14!null), MIN(t.title:18!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
			"         │   │   ├─ ci.movie_id:10!null\n" +
			"         │   │   └─ ml.linked_movie_id:0!null\n" +
			"         │   └─ Eq\n" +
			"         │       ├─ ml.linked_movie_id:0!null\n" +
			"         │       └─ t.id:17!null\n" +
			"         ├─ LookupJoin\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(n.name:15!null), MIN(pi.info:6!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(an1.name:10!null), MIN(t.title:16!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(an.name:10!null), MIN(t.title:16!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(a1.name:8!null), MIN(t.title:13!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(an1.name:8!null), MIN(t.title:13!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(an.name:11!null), MIN(chn.name:13!null), MIN(t.title:20!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(an.name:11!null), MIN(chn.name:13!null), MIN(n.name:15!null), MIN(t.title:20!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
...
`,
		ExpectedPlan: "Project\n" +
			...
			" └─ GroupBy\n" +
			"     ├─ select: MIN(an.name:10!null), MIN(chn.name:12!null), MIN(n.name:14!null), MIN(t.title:19!null)\n" +
			"     ├─ group: \n" +
			"     └─ InnerJoin\n" +
			"         ├─ AND\n" +
			"         │   ├─ Eq\n" +
