	...
	var scripts = []enginetest.ScriptTest{
		{
			...
			SetUpScript: []string{
				`CREATE TABLE IF NOT EXISTS schema_migrations (version bigint, inserted_at datetime, PRIMARY KEY (version)) ENGINE = INNODB`,
			},
			Assertions: []enginetest.ScriptTestAssertion{
				{
					Query: `insert into schema_migrations values (11, "2021-6-9 16:57:23");`,
