...
var ImdbData = []SetupScript{{
	...
	`analyze table aka_name update histogram on id using '{"row_count": 900662}';`,
}}
...
var Integration_testData = []SetupScript{{
	...
	`analyze table TPXBU update histogram on (id) using '{"row_count": 123867}';`,
	`analyze table THNTS update histogram on (id) using '{"row_count": 2498}';`,
	`analyze table JMRQL update histogram on (id) using '{"row_count": 3}';`,
	`analyze table YK2GW update histogram on (id) using '{"row_count": 2498}';`,
	`analyze table IJLXP update histogram on (id) using '{"row_count": 5661}';`,
	`analyze table HU5A5 update histogram on (id) using '{"row_count": 34}';`,
	`analyze table EPZU6 update histogram on (id) using '{"row_count": 213}';`,
	`analyze table WGSDC update histogram on (id) using '{"row_count": 68}';`,
	`analyze table SZW6V update histogram on (id) using '{"row_count": 0}';`,
	`analyze table SFEGG update histogram on (id) using '{"row_count": 380}';`,
	`analyze table JDLNA update histogram on (id) using '{"row_count": 399}';`,
	`analyze table I66GN update histogram on (id) using '{"row_count": 239}';`,
	`analyze table BACOW update histogram on (id) using '{"row_count": 5148}';`,
	`analyze table FLQLP update histogram on (id) using '{"row_count": 14781}';`,
	`analyze table S3FQX update histogram on (id) using '{"row_count": 1}';`,
	`analyze table JJGQT update histogram on (id) using '{"row_count": 6}';`,
	`analyze table AMYXQ update histogram on (id) using '{"row_count": 4786678}';`,
	`analyze table XGSJM update histogram on (id) using '{"row_count": 5}';`,
	`analyze table WE72E update histogram on (id) using '{"row_count": 3181}';`,
	`analyze table FCBVZ update histogram on (id) using '{"row_count": 0}';`,
	`analyze table RLOHD update histogram on (id) using '{"row_count": 226}';`,
	`analyze table T52LX update histogram on (id) using '{"row_count": 10}';`,
	`analyze table HDDVB update histogram on (id) using '{"row_count": 1112}';`,
	`analyze table YYBCX update histogram on (id) using '{"row_count": 12}';`,
	`analyze table FEVH4 update histogram on (id) using '{"row_count": 56}';`,
	`analyze table SR2I6 update histogram on (id) using '{"row_count": 71}';`,
	`analyze table NMYH3 update histogram on (id) using '{"row_count": 415}';`,
	`analyze table IMJ6V update histogram on (id) using '{"row_count": 6140}';`,
	`analyze table TDRVG update histogram on (id) using '{"row_count": 47285}';`,
	`analyze table IIISV update histogram on (id) using '{"row_count": 13}';`,
	`analyze table moa update histogram on (id) using '{"row_count": 36}';`,
	`analyze table FBPKL update histogram on (id) using '{"row_count": 60}';`,
	`analyze table TA5EB update histogram on (id) using '{"row_count": 70}';`,
	`analyze table HGMQ6 update histogram on (id) using '{"row_count": 511969}';`,
	`analyze table SEQS3 update histogram on (id) using '{"row_count": 535843}';`,
	`analyze table SZQWJ update histogram on (id) using '{"row_count": 3936}';`,
	`analyze table E2I7U update histogram on (id) using '{"row_count": 3842}';`,
	`analyze table ARLV5 update histogram on (id) using '{"row_count": 291}';`,
	`analyze table FEIOE update histogram on (id) using '{"row_count": 6367}';`,
	`analyze table TNMXI update histogram on (id) using '{"row_count": 5}';`,
	`analyze table F35MI update histogram on (id) using '{"row_count": 5}';`,
	`analyze table XOAOP update histogram on (id) using '{"row_count": 74}';`,
	`analyze table PG27A update histogram on (id) using '{"row_count": 11}';`,
	`analyze table NPCYY update histogram on (id) using '{"row_count": 89}';`,
	`analyze table TTGWX update histogram on (id) using '{"row_count": 3}';`,
	`analyze table QYWQD update histogram on (id) using '{"row_count": 70692}';`,
	`analyze table NOXN3 update histogram on (id) using '{"row_count": 11813}';`,
	`analyze table ZYGMF update histogram on (id) using '{"row_count": 81}';`,
	`analyze table TPXHZ update histogram on (id) using '{"row_count": 16}';`,
	`analyze table OUBDL update histogram on (id) using '{"row_count": 18395}';`,
	`analyze table SISUT update histogram on (id) using '{"row_count": 103907130}';`,
	`analyze table WRZVO update histogram on (id) using '{"row_count": 39091}';`,
	`analyze table NZKPM update histogram on (id) using '{"row_count": 18779716}';`,
	`analyze table FG26Y update histogram on (id) using '{"row_count": 1001}';`,
	`analyze table D34QP update histogram on (id) using '{"row_count": 36}';`,
	`analyze table ZTFET update histogram on (id) using '{"row_count": 64}';`,
...
var JoinData = []SetupScript{{
  ...
  key (orgId, name, val)
	...
	"analyze table customer1 update histogram on (`c_w_id`,`c_d_id`,`c_id`) using '{\"row_count\": 300000}';",
	`analyze table warehouse1 update histogram on (w_id) using '{\"row_count\": 10}';`,
	"analyze table stock1 update histogram on (`s_w_id`,`s_i_id`) using '{\"row_count\": 1000000}';",
	"analyze table order_line1 update histogram on (`ol_w_id`,`ol_d_id`,`ol_o_id`,`ol_number`) using '{\"row_count\": 3006058}';",
	"analyze table district1 update histogram on (`d_w_id`,`d_id`) using '{\"row_count\": 100}';",
	`analyze table item1 update histogram on (i_id) using '{\"row_count\": 100000}';`,
	"analyze table orders1 update histogram on (`o_w_id`,`o_d_id`,`o_id`) using '{\"row_count\": 300520}';",
}}
...
var TpccData = []SetupScript{{
	...
	"analyze table customer1 update histogram on (`c_w_id`,`c_d_id`,`c_id`) using '{\"row_count\": 30000}';",
	"analyze table customer2 update histogram on (`c_w_id`,`c_d_id`,`c_id`) using '{\"row_count\": 30000}';",
	"analyze table customer3 update histogram on (`c_w_id`,`c_d_id`,`c_id`) using '{\"row_count\": 30000}';",
	"analyze table customer4 update histogram on (`c_w_id`,`c_d_id`,`c_id`) using '{\"row_count\": 30000}';",
	"analyze table district1 update histogram on (`d_w_id`,`d_id`) using '{\"row_count\": 10}';",
	"analyze table district2 update histogram on (`d_w_id`,`d_id`) using '{\"row_count\": 10}';",
	"analyze table district3 update histogram on (`d_w_id`,`d_id`) using '{\"row_count\": 10}';",
	"analyze table district4 update histogram on (`d_w_id`,`d_id`) using '{\"row_count\": 10}';",
	"analyze table history1 update histogram on (`h_c_w_id`,`h_c_d_id`,`h_c_id`) using '{\"row_count\": 30000}';",
	"analyze table history2 update histogram on (`h_c_w_id`,`h_c_d_id`,`h_c_id`) using '{\"row_count\": 30000}';",
	"analyze table history3 update histogram on (`h_c_w_id`,`h_c_d_id`,`h_c_id`) using '{\"row_count\": 30000}';",
	"analyze table history4 update histogram on (`h_c_w_id`,`h_c_d_id`,`h_c_id`) using '{\"row_count\": 30000}';",
	`analyze table item1 update histogram on i_id using '{\"row_count\": 100000}';`,
	`analyze table item2 update histogram on i_id using '{\"row_count\": 100000}';`,
	`analyze table item3 update histogram on i_id using '{\"row_count\": 100000}';`,
	`analyze table item4 update histogram on i_id using '{\"row_count\": 100000}';`,
	"analyze table new_orders1 update histogram on (`no_w_id`,`no_d_id`,`no_o_id`) using '{\"row_count\": 9000}';",
	"analyze table new_orders2 update histogram on (`no_w_id`,`no_d_id`,`no_o_id`) using '{\"row_count\": 9000}';",
	"analyze table new_orders3 update histogram on (`no_w_id`,`no_d_id`,`no_o_id`) using '{\"row_count\": 9000}';",
	"analyze table new_orders4 update histogram on (`no_w_id`,`no_d_id`,`no_o_id`) using '{\"row_count\": 9000}';",
	"analyze table order_line1 update histogram on (`ol_w_id`,`ol_d_id`,`ol_o_id`,`ol_number`) using '{\"row_count\": 299498}';",
	"analyze table order_line2 update histogram on (`ol_w_id`,`ol_d_id`,`ol_o_id`,`ol_number`) using '{\"row_count\": 299498}';",
	"analyze table order_line3 update histogram on (`ol_w_id`,`ol_d_id`,`ol_o_id`,`ol_number`) using '{\"row_count\": 299498}';",
	"analyze table order_line4 update histogram on (`ol_w_id`,`ol_d_id`,`ol_o_id`,`ol_number`) using '{\"row_count\": 299498}';",
	"analyze table orders1 update histogram on (`o_w_id`,`o_d_id`,`o_id`) using '{\"row_count\": 30000}';",
	"analyze table orders2 update histogram on (`o_w_id`,`o_d_id`,`o_id`) using '{\"row_count\": 30000}';",
	"analyze table orders3 update histogram on (`o_w_id`,`o_d_id`,`o_id`) using '{\"row_count\": 30000}';",
	"analyze table orders4 update histogram on (`o_w_id`,`o_d_id`,`o_id`) using '{\"row_count\": 30000}';",
	"analyze table stock1 update histogram on (`s_w_id`,`s_i_id`) using '{\"row_count\": 100000}';",
	"analyze table stock2 update histogram on (`s_w_id`,`s_i_id`) using '{\"row_count\": 100000}';",
	"analyze table stock3 update histogram on (`s_w_id`,`s_i_id`) using '{\"row_count\": 100000}';",
	"analyze table stock4 update histogram on (`s_w_id`,`s_i_id`) using '{\"row_count\": 100000}';",
	`analyze table warehouse1 update histogram on w_id using '{\"row_count\": 1}';`,
	`analyze table warehouse2 update histogram on w_id using '{\"row_count\": 1}';`,
	`analyze table warehouse3 update histogram on w_id using '{\"row_count\": 1}';`,
	`analyze table warehouse4 update histogram on w_id using '{\"row_count\": 1}';`,
}}
 ...
 (
  ...
  primary key(t_time_sk)
   ...
   primary key(w_warehouse_sk)
	...
	`analyze table call_center update histogram on (cc_call_center_sk) using '{"row_count": 6}';`,
}}
...
var TpchData = []SetupScript{{
	...
	`analyze table customer update histogram on (C_CUSTKEY) using '{"row_count": 1000}';`,
	`analyze table orders update histogram on (O_ORDERKEY) using '{"row_count": 1000}';`,
	`analyze table lineitem update histogram on (L_ORDERKEY) using '{"row_count": 1000}';`,
	`analyze table nation update histogram on (N_NATIONKEY) using '{"row_count": 1000}';`,
	`analyze table part update histogram on (P_PARTKEY) using '{"row_count": 1000}';`,
	`analyze table partsupp update histogram on (PS_PARTKEY) using '{"row_count": 1000}';`,
	`analyze table region update histogram on (R_REGIONKEY) using '{"row_count": 1000}';`,
	`analyze table supplier update histogram on (S_SUPPKEY) using '{"row_count": 1000}';`,
}}
...
var XyData = []SetupScript{{
  ...
  (5,4);`,
	...
	`analyze table ab_hasnull update histogram on (a) using '{"row_count": 1000}';`,
	`analyze table xy update histogram on (x) using '{"row_count": 1000}';`,
	`analyze table xy_hasnull update histogram on (x) using '{"row_count": 1000}';`,
